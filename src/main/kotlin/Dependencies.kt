...
object Versions {
    ...
    const val materialDrawerMaterialTypeface = "2.2.0.6-kotlin"
    const val materialDrawerMaterialTypefaceOriginal = "3.0.1.4.original-kotlin"
    ...
    const val unoxAndroidArch = "0.50-next.13"
    const val unoxCore = "3.02-next.4"
